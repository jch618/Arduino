...
// Servo range
#define _DUTY_MIN 1210    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1400    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 1852        // [20213081] 서보 각도의 최댓값
...
// move servo to neutral position
  ...
  duty_chg_max = (_DUTY_MAX - _DUTY_MIN) * ((float)_SERVO_SPEED / _SERVO_ANGLE) * (_INTERVAL_SERVO / 1000.0);
  duty_chg_adjust = 2;
...
////////////////////
  ...
  // PID control logic
    ...
    if (iterm > 20.0 || iterm < -20.0) iterm *= 0.5;
    control = pterm + dterm + iterm; //[20203118] 
    if (dist_ema > 245 && dist_ema < 260) {
      control = 0;
//      control /= 2; 
    }
