...
#define _DUTY_MAX 1752        // [20213081] 서보 각도의 최댓값
...
// PID parameters
#define _KP 1.0      //[20191979] 비례제어 값

#define _POS_ALPHPA 0.1
...
float dist_prev, dist_raw, dist_ema, alpha; //[20203118] 거리와 노이즈 필터 적용 후 거리를 저장하기 위한 변수
...
//  if (duty_curr) duty_target = 1752;
//  else if (duty_curr < 250.0) duty_target = 1400;
